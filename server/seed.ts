...
export const seedUsers: ServerUser[] = [
  { id: "u-master-gmail", name: "Dono Wootech", role: "super_admin", email: "wootechsc@gmail.com", passwordHash: "$2b$10$DbsOfoZakxIYcdGRY13IROT51UNvgNEoin0h0axDX8JkpRMC1Arz2", isActive: true },
  { id: "u-master-wootech", name: "Dono Wootech", role: "super_admin", email: "wootechsc@outlook.com", passwordHash: "$2b$10$DbsOfoZakxIYcdGRY13IROT51UNvgNEoin0h0axDX8JkpRMC1Arz2", isActive: true },
